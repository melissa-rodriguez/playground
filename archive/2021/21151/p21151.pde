...
class Path {
  ...
  void update(float t) {
    pointPos.x= amp*(sin(PI/30*(radians(z)+t))); //updates the "sin" path
    pointPos2.x= amp*(sin(PI/30*(radians(z)+t))); //updates the "sin" path
    pointPos3.x= amp*(sin(PI/30*(radians(z)+t))); //updates the "sin" path
    pos.x= amp*(sin(PI/30*(radians(z)+t))); //updates the "sin" path
  }
}
