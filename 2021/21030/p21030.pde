...
color[] colorArray = new int[]{#F2F2F2, #BFBFBF, #8C8C8C, #595959, #FFFFFF};
...
void draw()
{
  ...
  for (int i=0; i<8e4; i++) {  
    ...
    //stroke(#62C2C5);
    //point(x*200/y+100*p, -n*100*x+50);
    //point(x*200/y+100*p, n*100*x+260);
    point(x*200/y+100*pow(10, q), -n*100*x+50);
    point(x*200/y+100*pow(p, p), n*100*x+260);


    //point(x*200/y, n*100*x+300);
